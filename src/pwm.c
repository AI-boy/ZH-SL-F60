...
void init_pwm(void)
{
	...
	PR4=0xFF;  		   				//PWM周期设置	Fosc=32MHz  PWM输出频率=50Khz  分辨率9位
									//PWM周期设置	Fosc=32MHz  PWM输出频率=31.4Khz  分辨率10位  2018-8-29
...
//				CCP3CONbits.DC3B=(unsigned char)(dduty&0b11);
//			}
//			else if((dnt%2)==1 && PWM_I>0)
//			{
//				CCPR3L=(unsigned char)((dduty+1)>>2);					//占空比设置  脉冲宽度
//	
//				CCP3CONbits.DC3B=(unsigned char)((dduty+1)&0b11);
//			}
//			else if((dnt%2)==0 && PWM_I<0)
//			{
//				CCPR3L=(unsigned char)(dduty>>2);					//占空比设置  脉冲宽度
//	
//				CCP3CONbits.DC3B=(unsigned char)(dduty&0b11);
