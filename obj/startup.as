	...
	; Compiler options:
	;
	; -oZH-SL-F60.cof -mZH-SL-F60.map --summary=default --output=default \
	...
	; -ID:\Program Files (x86)\Microchip\xc8\v1.30\include \
	; -ID:\MCUProject\ZH-SL-F60\include -P --runtime=default,+oscval:0 \
	; --opt=default,+asm,-debug,-speed,+space,9 --warn=0 -N255 -D__DEBUG=1 \
	; -Blarge --double=32 --float=32 --addrqual=ignore -g --asmlist \
...
;Stack space: 022D0h-0236Fh (160 bytes)
...
;	VCAPEN = RA6, VCAP functionality is enabled on RA6
